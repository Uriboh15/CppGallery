...
namespace CppGallery.Pages
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public static Dictionary<Type, string> PageDictionary { get; } = new Dictionary<Type, string>()
        {
            ...
            {typeof(Columns.ColumnsPage), "Column"},
            {typeof(Columns.Column1.Column1Page), "Column1-0"},
            {typeof(Columns.Column2.Column2Page), "Column2-0"},
            {typeof(Columns.Column3.Column3Page), "Column3-0"},
            {typeof(Columns.Column4.Column4Page), "Column4-0"},
            {typeof(Columns.Column5.Column5Page), "Column5-0"},
            {typeof(Columns.Column6.Column6), "Column6-0"},
            {typeof(Columns.Column7.Column7Page), "Column7-0"},
            {typeof(Columns.Column8.Column8Page), "Column8-0"},
            {typeof(Columns.Column9.Column9Page), "Column9-0"},
            {typeof(Columns.Column10.Column10Page), "Column10-0"},
            {typeof(Columns.Column11.Column11Page), "Column11-0"},
            {typeof(Columns.Column12.Column12Page), "Column12-0"},
            {typeof(Columns.Column13.Column13Page), "Column13-0"},
            {typeof(Columns.Column14.Column14Page), "Column14-0"},
            {typeof(Columns.Column15.Column15Page), "Column15-0"},
            {typeof(Columns.Column16.Column16Page), "Column16-0"},
            {typeof(Columns.Column17.Column17Page), "Column17-0"},
            {typeof(Columns.Column18.Column18), "Column18-0"},
            {typeof(Columns.Column19.Column19Page), "Column19-0"},
            {typeof(Columns.Column20.Column20Page), "Column20-0"},
            {typeof(Columns.Column21.Column21Page), "Column21-0"},
            {typeof(Columns.Column22.Column22Page), "Column22-0"},
        ...
        private static Dictionary<string, string> AMD { get; } = new Dictionary<string, string>()
        {
            ...
            {"BaseOperator", "基本演算子" },
            {"Column", "コラムの極み"},
            {"Column1-0", "scanf で安全に文字列入力する方法"},
            {"Column2-0", "ファイルを fclose しないとどうなる？"},
            {"Column3-0", "if文の == を間違えて = と書いたらどうなる？"},
            {"Column4-0", "実数型の精度ってどれくらい？"},
            {"Column5-0", "任意のキーを押してプログラムを終了する方法"},
            {"Column6-0", "NULL と nullptr の違い"},
            {"Column7-0", "動的 2 次元配列 (malloc ・ 方法 1)"},
            {"Column8-0", "getchar で整数を取り込む関数を自作"},
            {"Column9-0", "getchar で安全に文字列入力する関数を自作"},
            {"Column10-0", "動的 2 次元配列 (vector クラス)"},
            {"Column11-0", "ファイルサイズを取得する方法"},
            {"Column12-0", "動的 2 次元配列 (malloc ・ 方法 2)"},
            {"Column13-0", "文字列の Split 関数を自作"},
            {"Column14-0", "WinUI 3 でダークモード時にタイトルバーを黒くする方法"},
            {"Column15-0", "C# から C/C++ の関数を呼ぶ方法"},
            {"Column16-0", "valarray で分散などを求める関数を自作"},
            {"Column17-0", "Windows 11 の角丸を無効化する方法"},
            {"Column18-0", "dll ファイルから Win32 API の関数ポインタを取得する方法"},
            {"Column19-0", "ComboBox で選択した項目を取得する方法"},
            {"Column20-0", "WinUI 3 でタイトルバーをカスタマイズする方法"},
            {"Column21-0", "UserControl を作成する方法"},
            {"Column22-0", "Windows 11 22H2 でタイトルバーの視覚効果を変更する方法"},
        ...
        private void ContentFrame_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            if (tag[tag.Length - 1] == '0')
            {
                ...
                switch (tag[0])
                {
                    ...
                    case 'C':
                        folder = AMD["Column"];
                        NavView.SelectedItem = GetNavigationViewItem("Column");
                        break;
